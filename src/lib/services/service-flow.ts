...
> = {
  georreferenciamento: [
    ...
    { name: "Geo Concluido", slug: "geo-concluido", position: 8 },
  ...
  car: [
    ...
    { name: "Prioridade", slug: serviceFlowSlugs.priority, position: 4 },
    { name: "CAR Protocolado/Em Analise", slug: "car-protocolado-em-analise", position: 5 },
    { name: "CAR Concluido", slug: "car-concluido", position: 6 },
  ...
  itr_ccir: [
    ...
    { name: "Prioridade", slug: serviceFlowSlugs.priority, position: 4 },
    { name: "Protocolado/Enviado", slug: "protocolado-enviado", position: 5 },
  ...
  outros_servicos: [
    ...
    { name: "Prioridade", slug: serviceFlowSlugs.priority, position: 4 },
    { name: "Concluido", slug: "concluido", position: 5 },
    { name: "Servico perdido", slug: serviceFlowSlugs.lost, position: 6 },
  ],
};
