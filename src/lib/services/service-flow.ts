...
> = {
  georreferenciamento: [
    ...
    { name: "Antigos a concluir", slug: serviceFlowSlugs.oldToFinish, position: 9 },
    { name: "Geo Concluido", slug: "geo-concluido", position: 10 },
  ...
  car: [
    ...
    { name: "Prioridade", slug: serviceFlowSlugs.priority, position: 5 },
    { name: "Em atraso", slug: serviceFlowSlugs.overdue, position: 6 },
    { name: "Aguardando Sincronizacao", slug: "aguardando-sincronizacao", position: 7 },
  ...
  itr_ccir: [
    ...
    { name: "Prioridade", slug: serviceFlowSlugs.priority, position: 5 },
    { name: "Em atraso", slug: serviceFlowSlugs.overdue, position: 6 },
    { name: "Protocolado/Enviado", slug: "protocolado-enviado", position: 7 },
    { name: "Antigos a concluir", slug: serviceFlowSlugs.oldToFinish, position: 8 },
    { name: "Concluido", slug: "concluido", position: 9 },
...
export function getServiceCardTone({
  ...
  if (columnSlug === serviceFlowSlugs.priorityMax) return "warning";
