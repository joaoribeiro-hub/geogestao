...
export const serviceFlowSlugs = {
  ...
  priority: "prioridade",
  overdue: "em-atraso",
  oldToFinish: "antigos-a-concluir",
...
> = {
  georreferenciamento: [
    ...
    { name: "Prioridade", slug: serviceFlowSlugs.priority, position: 3 },
    { name: "Em atraso", slug: serviceFlowSlugs.overdue, position: 4 },
    { name: "Geo Protocolado no Cartorio", slug: "geo-protocolado-cartorio", position: 5 },
    { name: "Geo Protocolado no INCRA", slug: "geo-protocolado-incra", position: 6 },
    { name: "Geo - Pendencia de Confrontante", slug: "geo-pendencia-confrontante", position: 7 },
    { name: "Antigos a concluir", slug: serviceFlowSlugs.oldToFinish, position: 8 },
  ...
  car: [
    ...
    { name: "Aguardando Sincronizacao", slug: "aguardando-sincronizacao", position: 6 },
    { name: "Antigos a concluir", slug: serviceFlowSlugs.oldToFinish, position: 7 },
    { name: "CAR Concluido", slug: "car-concluido", position: 8 },
  ],
  itr_ccir: [
    { name: "Aguardando documentos", slug: serviceFlowSlugs.awaitingDocuments, position: 1 },
    ...
    { name: "Antigos a concluir", slug: serviceFlowSlugs.oldToFinish, position: 7 },
    { name: "Concluido", slug: "concluido", position: 8 },
    { name: "Servico perdido", slug: serviceFlowSlugs.lost, position: 9 },
  ],
  outros_servicos: [
    { name: "Aguardando documentos", slug: serviceFlowSlugs.awaitingDocuments, position: 1 },
    { name: "Proposta/Contrato", slug: serviceFlowSlugs.proposalContract, position: 2 },
    ...
    { name: "Prioridade", slug: serviceFlowSlugs.priority, position: 4 },
    { name: "Em atraso", slug: serviceFlowSlugs.overdue, position: 5 },
    { name: "Antigos a concluir", slug: serviceFlowSlugs.oldToFinish, position: 6 },
